...
`frameworks/frontend/` is split into three narrower categories rather
...
...), and `templating/` covers server-side template engines (Pug,
Blade, Jinja2, ...) that aren't JS frameworks at all.
